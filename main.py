...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Script for diode simulation')
    ...
    parser.add_argument('--output', '--o', default='currents', type=str, help='Data output file name')
